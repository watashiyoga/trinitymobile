...
function TrinityMobile() {
    ...
    this.blogResponse = function (args, trinityBlogXML) {
        ...
        for (i = 0; i < 5; i++) {
            ...
            tcBlogItem.innerHTML = "<br/><p style=\"font-size: large;font-weight:bold;" +
    ...
    this.twitterResponse = function (args, trinityTwitterXML) {
        ...
        var i = 0,
            ...
            tcTwitterStatusFinal = "",
            
            tcTwitterHandle = "TrinityEastonPA: ",
        ...
        for (i = 0; i < tcStatusLength; i++) {
            ...
            tcTwitterStatusFinal = tcTwitterStatus.replace(tcTwitterHandle,"");
            ...
            tcTwitterLI.innerHTML = "<p style=\"white-space: normal;\">" +
                tcTwitterStatusFinal;
            tcTwitterLI.innerHTML += "<span style=\"font-size:small;\">" + 
                tcStatusDate + " <a href=\"" + tcStatusURL +
                 "\">View Tweet</a></span></p>";
        }
    ...
    this.facebookResponse = function (args, trinityFacebookXML) {
        ...
        for (i = 0; i < tcFacebookLength; i++) {
            ...
            tcFacebookDiv.innerHTML += "<p class=\"ui-li\">";
    ...
    this.serviceTimesResponse = function (args, serviceTimesXML) {
        ...
        var i = 0,
            ...
            tcAllRegular = serviceTimesXML.getElementsByTagName("regular"),
            tcAllSpecial = serviceTimesXML.getElementsByTagName("special"),
            tcAllServicesLength = tcAllRegular.length + tcAllSpecial.length,
            ...
            tcRegularLength = tcAllRegular.length,
        ...
        for (i = 0; i < tcSpecialLength; i++) {
            ...
            if(tcSpecialService.getElementsByTagName("date")[0]!=undefined){
            tcSpecialServiceDate =
                tcSpecialService.getElementsByTagName("date")[0].
                    firstChild.nodeValue;}
             else {tcSpecialServiceDate = "";}
            ...
            tcSpecialLocation =
                ...
                tcSpecialServiceTimesDiv.innerHTML += "<p>" + 
                    tcSpecialTime;
                tcSpecialServiceTimesDiv.innerHTML += tcSpecialType + "<br/>";
        ...
        for (j = 0; j < tcRegularLength; j++) {

            //The service currently being processed.
            tcService = tcAllRegular[j];
            
            //Get the day of the service (Sunday, Monday, etc).
            tcServiceDayOrig = tcService.getElementsByTagName("day")[0].
                firstChild.nodeValue;
